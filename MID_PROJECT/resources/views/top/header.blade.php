 ...
 <section id="topbar" class="topbar d-flex align-items-center">
     <div class="container d-flex justify-content-center justify-content-md-between">
         <div class="contact-info d-flex align-items-center">
             <i class="bi bi-envelope d-flex align-items-center"><a href="https://mail.google.com/mail/u/0/#inbox">litol@gmail.com</a></i>
             <i class="bi bi-phone d-flex align-items-center ms-4"><span>+880-1794269979</span></i>
         </div>
